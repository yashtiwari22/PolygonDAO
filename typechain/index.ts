...
export type { MyDAO } from "./contracts/PolygonDAO.sol/MyDAO";
export { MyDAO__factory } from "./factories/contracts/PolygonDAO.sol/MyDAO__factory";
export type { PolygonDAO } from "./contracts/PolygonDAO.sol/PolygonDAO";
export { PolygonDAO__factory } from "./factories/contracts/PolygonDAO.sol/PolygonDAO__factory";
